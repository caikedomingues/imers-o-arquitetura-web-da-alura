...
# 3. Lista chamada `figurinhas` com as 30 figurinhas.
...
# Como as imagens de 1 a 29 estão presentes na pasta, elas ficam ativas.
# A figurinha 30 (Você) é comentada pois não tem imagem correspondente no diretório.
figurinhas = [
...
# 4. Cria o endpoint GET "/figurinhas" que retorna a lista
@app.get("/figurinhas")
def listar_figurinhas():
    return figurinhas

# 5. Cria o endpoint GET "/figurinhas/{id}/imagem"
